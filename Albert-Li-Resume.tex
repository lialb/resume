...
%-------------------------------------------
    ...
    \resumeSubheading
      {CS 196: Freshman Honors} % Company
      {January 2020 --- May 2021} % Date
      {Course Staff} % Position
      {UIUC Deparment of Computer Science} % Location
      \resumeItemListStart
      ...
      {Champaign, IL} % Location
      \resumeItemListStart
        \resumeItem{Created a project management web dashboard for analysts / managers using Angular, Flask API, and OracleDB}
