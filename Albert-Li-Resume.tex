...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \footnotesize{\textbf{Relevant Coursework}{: Distributed Systems, Communication Networks, Computer Security, Database Systems, Algorithms, Systems Programming, Data Structures, Computer Architecture, Software Design Studio, UI Design, Bioinformatics, Applied Machine Learning }}
    \vspace{-6pt}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
    \resumeSubheadingSmall
      ...
      \resumeItemListStart
        \resumeItem{Working on the backend team}
      \resumeItemListEnd
    ...
    \resumeSubheadingSmall
      ...
      \resumeItemListStart
        \resumeItem{Created the Reels viewer $0\rightarrow1$ product for Facebook and tested product across USA, India, Canada, and Mexico before global launch}
