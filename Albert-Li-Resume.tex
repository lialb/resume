...
{Software Engineer Intern --- Kotlin, Python, Terraform, Kubernetes, AWS} % Position
{Redwood City, CA} % Location
\resumeItemListStart
\resumeItem{Added rate limiting and billing/metering logic to customers in a Kotlin service}
\resumeItem{Enforced real time quota for customers to prevent overuse of services, such as Salesforce, Twilio, etc.}
\resumeItem{Created an internal tool run on AWS Lambda and webhooks to enforce Github compliance on all repos in organization}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Created Facebook Reels viewer $0 \rightarrow 1$ product and tested across USA, India, Canada, and Mexico before global launch}
\resumeItem{Built facebook.com/reel from scratch with bug reporting, sharing across FB platforms, blocking, liking, commenting, etc.}
...
\resumeItem{Spearheaded telemetry and logging infrastructure tracking product data for insights in customer usage and adoption}
\resumeItemListEnd
