...
\footnotesize{\textbf{Relevant Coursework}{: Distributed Systems, Communication Networks, Computer Security, Database Systems, Algorithms, Systems Programming, Data Structures, Computer Architecture, UI Design, Bioinformatics}}
\vspace{-6pt}
...
\resumeItem{Built product from scratch with bug reporting, sharing across FB platforms, blocking, liking, commenting, etc.}
\resumeItem{Generated millions of monthly active users and led development across multiple engineering and design teams}
\resumeItemListEnd
